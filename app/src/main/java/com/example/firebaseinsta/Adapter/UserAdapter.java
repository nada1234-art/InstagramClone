...
import com.example.firebaseinsta.MainActivity1;
...
//is this method we will make the user know if he's following the other users or not, if not he follow him (we manage this in the follow botton)
